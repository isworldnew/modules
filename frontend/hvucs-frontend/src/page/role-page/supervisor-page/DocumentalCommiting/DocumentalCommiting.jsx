...
export default function DocumentalCommiting() {
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            ...
            //
            // Удаляем placeholder у пустых полей
            //
            ...
            //     //
            //     // ВАЖНО:
            //     // всегда сохраняем нижнюю линию,
            //     // даже если поле пустое
            //     //
            ...
            //     //
            //     // Если поле пустое —
            //     // оставляем минимальную высоту строки
            //     //
            //     if (value.trim()) {
            //         div.style.minHeight =
            //             Math.max(
            ...
            //     } else {
            //         div.style.minHeight =
            //             parseFloat(styles.lineHeight) + 'px';
            //     }
...
//
            clone.querySelectorAll('textarea').forEach((textarea) => {
                ...
                //
                // Всегда оставляем несколько строк
...
//         // Клонируем компонент и очищаем от лишних стилей
//         const clone = actRef.current.cloneNode(true);
...
//         // Убираем все трансформации из дочерних элементов
...
//             scale: 2,
//             backgroundColor: '#ffffff',
//             windowWidth: 210 * 3.7795275591, // mm to px
//             logging: false
//         });
...
//         pdf.save(`${incidentData.responseId || 'akt'}.pdf`);
//     };
